  ...
  if (desktop) {
    return (
      <aside className="hidden xl:block sticky top-28 self-start">
        <a
          href={backHref}
          className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs text-white/50 bg-white/[0.04] border border-white/[0.08] hover:text-white/70 hover:border-white/[0.15] transition-all mb-5"
        >
        ...
        <nav>
          <p className="text-[10px] font-semibold text-white/50 uppercase tracking-widest mb-2">Contents</p>
